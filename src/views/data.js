const data = [
  {
    ...
    sensorDetail:
      "2 greyscale cameras 1.4 MP, 2 color cameras 1.4 MP, 1 lidar 64 beams 360° 10Hz, 1 inertial and GPS navigation system",
    benchmark:
      "stereo, optical flow, visual odometry, slam, 3d object detection, 3d object tracking",
  ...
  },
  {
    ...
    sensorDetail:
      "1x lidar 32 channels 360° 20Hz, 5x long range radar 13Hz, 6x camera 1600x1200 12Hz, 1x gps/imu 1000Hz",
    benchmark:
      "3d object detection, tracking, trajectory (prediction), lidar segmentation, panoptic segmentation & tracking",
    annotations: "semantic category, attributes, 3d bounding boxes ",
    licensing:
      "Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International Public (CC BY-NC-SA 4.0)",
  ...
  },
  {
    ...
    benchmark: "-",
    annotations:
      "instance masks, 2d bounding boxes, semantic segmentation masks, attribute annotations",
    licensing:
      "Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International Public (CC BY-NC-SA 4.0)",
  ...
  },
  {
    ...
    licensing:
      "freely available for non-commercial research and educational use",
  ...
  },
  {
    ...
    relatedPaper:
      "https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=5206631",
  ...
  },
  {
    ...
    sensorDetail:
      "5x cameras (front and sides) 1920x1280 & 1920x1040, 1x mid-range lidar, 4x short-range lidars",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "-",
    ...
    location:
      "San Francisco, Mountain View, Los Angeles, Detroit, Seattle and Phoenix, USA",
    rawData: "Yes",
  ...
  },
  {
    ...
    sensorDetail:
      "1x camera Bumblebee XB3 1280x960x3 16Hz, 3x camera Grasshopper2 1024x1024 12Hz, 2x lidar SICK LMS-151 270° 50Hz, 1x lidar SICK LD-MRS 90° 4 plane 12.5Hz, 1x NovAtel SPAN-CPT ALIGN 50Hz GPS+INS",
    benchmark: "-",
    annotations: "-",
    licensing:
  ...
  },
  {
    ...
    sensorDetail:
      "crowd-sourced therefore no fixed setup, camera (720p) and gps/imu",
    benchmark:
      "object detection, instance segmentation, multiple object tracking, segmentation tracking, semantic segmentation, lane marking, drivable area, image tagging, imitation learning, domain adaption",
    annotations:
      "bounding boxes, instance segmentation, semantic segmentation, box tracking, semantic tracking, drivable area",
  ...
  },
  {
    ...
    mapData: "Yes",
    benchmark:
      "semantic image segmentation and instance-specific image segmentation",
    ...
    paperTitle:
      "The Mapillary Vistas Dataset for Semantic Understanding of Street Scene",
  ...
  },
  {
    ...
    sensorDetail:
      "2x lidar 32 beam 40° 10Hz, 7x ring cameras 1920x1200 combined 360° 30Hz, 2x front-view facing stereo cameras 0.2986m baseline 2056x2464 5Hz",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps",
    sensorDetail:
      "2x lidar 40° 10Hz, 7x ring cameras 1920x1200 combined 360° 30Hz, 2x front-view facing stereo cameras 2056x2464 5Hz",
    benchmark: "tracking",
  ...
  },
  {
    ...
    relatedDatasets:
      "Argoverse 3D Tracking, Argoverse 1 Maps, Argoverse 1 Motion Forecasting and  Argoverse 2",
  ...
  },
  {
    ...
    relatedPaper:
      "https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=6335478&casa_token=iD5J89e1Y0MAAAAA:OKU-qJJPvSmZk1wJGlPb4G3Z7SF12nHZdr7mEV03pwgl2Q8ASZlH7T2zbo5n65e4yBniT_S5jQfn&tag=1",
    location: "USA",
    rawData: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "2x VUX-1HA laser scanners 360°, 1x VMX-CS6 camera system, 1x measuring head with gnss/imu, 2x high frontal cameras 3384 ×2710",
    benchmark:
      "2d image parsing, 3d car instance understanding, landmark segmentation, self-localization, trajectory prediction, 3d detection, 3d tracking, stereo",
    annotations:
      "high density 3d point cloud map, per-pixel, per-frame semantic image label, lane mark label semantic instance segmentation, geo-tagged",
    licensing: "freely available for non-commercial purposes",
    relatedDatasets: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar",
    sensorDetail:
      "6x cameras 2.4MP 1936x1216 10Hz, 1x Luminar-H2 Lidar sensor 360° 10Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    ...
    location:
      "USA (Ann Arbor, San Francisco Bay Area, Detroit, Cambridge and Massachusetts), Japan (Tokyo and Odaiba)",
    rawData: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "1x Point Grey Ladybug3 omnidirectional camera 1600x600 8Hz, 1x Velodyne HDL-64E lidar 360° 10Hz, 2x Riegl LMS-Q120 lidars 80°, 1x Applanix POS-LV 420 INS with Trimble GPS 100Hz, 1x Xsens MTi-G IMU 100Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark:
      "SLAM, iterative closest point (ICP), and 3D object detection and recognition",
    annotations: "-",
    ...
    relatedPaper:
      "https://journals.sagepub.com/doi/pdf/10.1177/0278364911400640",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "1x Pointgrey Ladybug3 (LB3) camera system 1600x1200 5Hz, 1x Velodyne HDL-32E lidar 360° 10Hz, 1x Hokuyo UTM-30LX lidar 270°, 1x Hokuyo URG-04LX lidar 240°, 1x Microstrain 3DM-GX3-45 IMU 100Hz, 1x KVH DSP-3000 single-axis FOG, 1x Garmin 18x 5Hz, 1x NovAtel DL-4 plus RTK GPS 1Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
    ...
    relatedPaper:
      "http://robots.engin.umich.edu/publications/ncarlevaris-2015a.pdf",
  ...
  },
  {
    ...
    sensorDetail:
      "2x DAVIS m346B camera 346x60 83° 50Hz, 1x Velodyne Puck LITE 360° 20Hz, 1x Skybotix integrated VI-sensor stereo camera: 2 x Aptina MT9V034, 1x UBLOX NEO-M8N gps",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "1x Point Grey Research Bumblebee 2 stereo camera 1024x768 20Hz, 3x Hokuyo UTM-30LX laser scanners 270°, 2x SICK LMS-200 laser scanners, 1x xSens MTi imu 100Hz, 2x mmGPS devices from Topcon gps",
  ...
  },
  {
    ...
    annotations: "2d bounding box with class labels",
    licensing:
      "Freely available to academic and non-academic entities for non-commercial purposes",
    relatedDatasets:
      "Daimler Pedestrian Segmentation Benchmark Dataset, Tsinghua-Daimler Cyclist Detection Benchmark Dataset",
    publishDate: "2013-08-25",
    lastUpdate: "-",
    paperTitle:
      "Pedestrian Path Prediction with Recursive Bayesian Filters: A Comparative Study",
    relatedPaper:
      "https://link.springer.com/chapter/10.1007/978-3-642-40602-7_18",
    location: "-",
    rawData: "-",
  ...
  },
  {
    ...
    mapData: "No",
    benchmark:
      "Pixel-Level Semantic Segmentation Task, Instance-Level Semantic Segmentation Task",
    annotations: "semantic segmentation",
    licensing: "-",
    relatedDatasets: "-",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "raw 12bit HDR images with a red-clear-clear-blue filter 1280x720 & reconstructed 8-bit RGB color images 1280x720",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    ...
    relatedPaper:
      "https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7989163",
    location: "-",
    rawData: "Yes",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "1x Point Grey's Bumblebee XB3 (BBX3-13S2C-60) stereo camera 1280x960 ",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    annotations:
      "2d bounding boxes with the description of state of traffic light",
    licensing:
      "Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)",
  ...
  },
  {
    ...
    sensorDetail:
      "3x Point Grey Grasshopper 3 video cameras 1920x1200 30Hz, 1x Velodyne HDL-64E S2 3D LiDAR 360° 10Hz, 1 x GeneSys Eletronik GmbH Automotive Dynamic Motion Analyzer with DGPS 120Hz, 1x Vehicle Controller Area Network 100Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
    ...
    licensing:
      "Available for research for people affiliated with a university upon registration",
  ...
  },
  {
    ...
    sensorDetail:
      "1x Velodyne HDL-64E S2 lidar 360° 10Hz, 1x Applanix LV-420 gps 200Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "7 cameras with 360° view, 3 lidars with 40-64 channels at 10Hz, 5 radars",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "2x PointGrey Flea3 RGB camera 1280x960, 1x FLIR A655Sc thermal camera 640x480 50Hz, 1x Velodyne HDL-32E 3D LiDAR 360° 32 beams 10Hz, 1x OXTS RT2002 gps/ins 100Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark:
      "object detection, vision sensor enhancement, depth estimation, multi-spectral colorization",
    ...
    relatedPaper:
      "https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=8293689",
    location: "-",
    rawData: "Yes",
  ...
  },
  {
    ...
    sensorDetail:
      "1x roof mounted GARMIN VirbX camera 1080p 25Hz, 1x SMI ETG 2w Eye Tracking Glasses (ETG) 60Hz, 1x frontal camera 720p 30Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "1x camera 1920x1080 110°, 1x camera 1920x1080 170°, 1x camera 1280x720 100°",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "4x 1MPx RGB fisheye cameras 190°, 1x Velodyne HDL-64E lidar 20Hz, 1x NovAtel Propak6 & SPAN-IGM-A1 gnss/imu, 1x Garmin 18x GNSS Positioning with SPS, Odometry signals from the vehicle bus",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    annotations:
      "semantic segmentation, monocular depth estimation, 2D & 3D bounding boxes,  visual odometry, visual SLAM, motion segmentation, soiling detection and end-to-end driving (driving controls)",
    licensing: "Freely available for non-commercial research",
    relatedDatasets: "-",
    publishDate: "2019-10-27",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "5x lidar 16 channels 360° 10Hz, 1x front centre camera 1920x1208 30Hz, 5x surround cameras1920x1208 30Hz, vehicle bus data",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
    annotations:
      "semantic segmentation, point cloud segmentation, instance segmentation, 3d bounding boxes",
    licensing:
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "3x color PointGrey Grasshopper3 video cameras 1920x1200 90°/80° 30Hz, 1x Velodyne HDL-64E LiDAR 64 beams 360° 10Hz, 1x GeneSys Eletronik GmbH Automotive Dynamic Motion Analyzer 100Hz",
    recordingPerspective: "Ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "2x 180° fisheye camera, 1x 90° perspective stereo camera, 1x Velodyne HDL-64E & SICK LMS 200 laser scanning unit in pushbroom configuration",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "2x FLIR FL3-U3-20E4C-C Global shutter color camera 1280x560 10Hz, 2x Velodyne VLP-16 16 CH LiDAR 360° 10Hz, 2x SICK LMS-511 1 CH LiDAR 190° 100Hz, 1x U-Blox EVK-7P Consumer-level GPS 10Hz, 1x SOKKIA GRX 2 VRS-RTK GPS 1Hz, 1x Xsens MTi-300 Consumer-level AHRS imu 200Hz, 1x  myPressure Altimeter sensor 10Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
    ...
    relatedPaper:
      "https://journals.sagepub.com/doi/pdf/10.1177/0278364919843996",
  ...
  },
  {
    ...
    relatedPaper:
      "https://openaccess.thecvf.com/content_ECCV_2018/papers/Oliver_Zendel_WildDash_-_Creating_ECCV_2018_paper.pdf",
  ...
  },
  {
    ...
    sensors: "camera, gps",
    sensorDetail:
      "1x monocular dashboard camera Waylens Horizon 1920x1080 157° 30Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    annotations:
      "2d bounding boxes for pedestrians with occlusion flages, text labels for pedestrian actions, crossing intention confidence scores, gps data and vehicle informatiom for every frame",
    licensing: "MIT License",
    ...
    relatedPaper:
      "https://openaccess.thecvf.com/content_ICCV_2019/papers/Rasouli_PIE_A_Large-Scale_Dataset_and_Models_for_Pedestrian_Intention_Estimation_ICCV_2019_paper.pdf",
    location: "Toronto, Canada",
    rawData: "Yes",
  ...
  },
  {
    ...
    sensorDetail:
      "1x Ouster OS1-64 64 channel lidar 360° 10Hz, 1x Navtech CIR204-H radar 360° 4Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "RGB images in PNG format 1440x720 & upscaled version 2048x1024",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    annotations:
      "2d bounding boxes, 3d bounding boxes, occlusion, truncation, semantic segmentation,instance segmentation, depth segmentation, scene metadata",
    licensing: "freely available for non-commercial purposes",
    relatedDatasets: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps",
    sensorDetail:
      "7x high-resolution ring cameras 2048x1550 combined 360° 20Hz, 2x front-view facing stereo cameras 20Hz, 2x VLP-32C lidar sensors 360° 10Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
    ...
    location:
      "Austin, Detroit, Miami, Palo Alto, Pittsburgh, and Washington D.C, USA",
    rawData: "Yes",
    DOI: "-",
    citationCount: 119,
    completionStatus: "complete",
  ...
  },
  {
    ...
    sensorDetail:
      "8x camera Ximea MQ013CG-E2 1280x1024 10Hz,  1x lidar Veldyne VLP-32C 360° 10Hz, 1x NovAtel OEM638 Triple-Frequency GPS, 1x Sensonor STIM300 MEMS 100Hz IMU, 2x Xsens 200Hz IMU",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "1x RIEGL VMX-250-CS6 laser scanner, 1x stereo system with 2 cameras 2560x1080 69.5° 200Hz, 1x Applanix POS-LV 510 gnss & imu unit",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark:
      "stereo, optical flow, single image depth prediction, object detection, and semantic segmentation",
    ...
    relatedPaper:
      "http://hci-benchmark.iwr.uni-heidelberg.de/media/publications//kondermann2016.pdf",
    location: "-",
    rawData: "-",
  ...
  },
  {
    ...
    relatedPaper:
      "http://wwwlehre.dhbw-stuttgart.de/~sgehrig/stixelGroundTruthDataset/stixel.pdf",
    location: "-",
    rawData: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "1x Velodyne HDL-32E laser scanner 360° 10Hz, 1x Velodyne VLP-16 laser scanner, 1x color dashboard camera 1920x1080 30Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
  ...
  },
  {
    ...
    sensorDetail:
      "1x HDL-32E Velodyne lidar 360° 10Hz, 1x VLP-16 Velodyne lidar, 1x Dashboard camera 1920x1080 30Hz ",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    ...
    paperTitle:
      "LiDAR-Video Driving Dataset: Learning Driving Policies Effectively",
    relatedPaper:
      "https://openaccess.thecvf.com/content_cvpr_2018/papers/Chen_LiDAR-Video_Driving_Dataset_CVPR_2018_paper.pdf",
    location: "-",
    rawData: "-",
    DOI: "10.1109/CVPR.2018.00615",
    citationCount: 93,
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "Original images gathered online and synthetic discrpencies inserted 1280x720",
    recordingPerspective: "ego-perspective",
    dataType: "Synthetic",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps",
    sensorDetail:
      "1x Teledyne Optech Maverick consists of a 32-line LiDAR sensor, a Ladybug 5 panoramic camera, a GNSS system, and a SLAM system",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "based on the validation set of Cityscapes overlayed with anomalous objects and the original LostAndFound with extended pixel-wise annotations",
    recordingPerspective: "ego-perspective",
  ...
  },
  {
    ...
    licensing:
      "Freely available to academic and non-academic entities for non-commercial purposes",
    relatedDatasets:
      "Daimler Pedestrian Segmentation Benchmark Dataset, Tsinghua-Daimler Cyclist Detection Benchmark Dataset, Daimler Pedestrian Path Prediction Benchmark Dataset",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "1x Nerian Karmin2 + Nerian SceneScan: 3D StereoCamera 10Hz, 1x RGB Camera: Basler acA1920-50gc camera with 16mm/F18 EDMUND Optics lens 1920x1200 10Hz, 1x Ouster OS1 LiDAR 64 Channels 10 Hz, 1x Velodyne Ultra Puck: 32 Channels 10Hz, Vectornav VN-300 Dual Antenna GNSS/INS 300Hz GPS, 100Hz IMU",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar",
    sensorDetail:
      "2x PointGrey Chameleon3 USB3 Global shutter color cameras 2048x1536 57.3° 55Hz, 1x Velodyne HDL-64ES3 3D-LiDAR 10Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "3d object detection",
    annotations: "3d bounding boxes",
    licensing:
      "Freely available for noncommercial academic research purposes only",
    relatedDatasets: "-",
  ...
  },
  {
    ...
    benchmark: "-",
    annotations:
      "location and tracking information of objects for predicting future ego-motion",
    licensing:
      "Available for research for people affiliated with a university upon registration",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "Images taken from SemanticKITTI dataset and modified with annotations",
    recordingPerspective: "ego-perspetive",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "Images taken from Cityscapes dataset and modified with annotations",
    recordingPerspective: "ego-perspetive",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    relatedPaper:
      "https://www.spiedigitallibrary.org/journals/Optical-Engineering/volume-51/issue-2/021107/Outdoor-stereo-camera-system-for-the-generation-of-real-world/10.1117/1.OE.51.2.021107.short?SSO=1",
    location: "-",
    rawData: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "1x Prosilica GT2750C camera 1376x1110, 1x Velodyne HDL-32 LiDAR, 1x Garmin GPS receiver, 1x Microstrain GX3-25 IMU",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "1x forward-facing color camera, 4x wide-angle mono cameras 360°, 1x Pandora LiDAR 360°, 1x XW-GI7660 GPS/IMU",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
  ...
  },
  {
    ...
    benchmark: "-",
    annotations:
      "2d bounding boxes for objects, trajectory tracking information",
    licensing: "Freely available for non-commercial use only upon registration",
  ...
  },
  {
    ...
    benchmark: "-",
    annotations:
      "2d bounding boxes for vehicles and pedestrians, pedestrian/vehicles action attributes and trajectory information",
    licensing:
      "Available for research for people affiliated with a university upon registration",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "4x HDL-32E Lidars, 4x Flea3 GigE Point Grey Cameras in stereo pairs (front & back) 80° 15Hz,2x Flea3 GigE Point Grey Cameras (sides) 80° 15Hz, 1x Flea3 GigE Point Grey Camera 40° 7Hz, 1x Applanix POS LV gps/imu",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "5x wide angle cameras 1920x1080 10Hz, 1x long focus camera 1920x1080 10Hz, 1x mechanical spinning LiDAR 64 channels 360° 10Hz, 1x forward-facing LiDAR 150 channels 60° 10Hz1x mechanical spinning LiDAR, 1x forward-facing LiDAR, 6x cameras, on-board GPS/IMU",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    ...
    licensing:
      "Creative Commons Attribution 4.0 International Public (CC BY 4.0)",
    relatedDatasets: "-",
    publishDate: "2020-04-01",
    lastUpdate: "-",
    paperTitle:
  ...
  },
  {
    ...
    sensorDetail:
      "10 different lidars compared (VLS-128, HDL-64S2, HDL-32E, VLP-32C, VLP-16, Pandar64, Pandar40P, OS1-64, OS1-16, RS-Lidar32)",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
  ...
  },
  {
    ...
    annotations: "semantic segmentation",
    licensing:
      'various, see "https://github.com/SegmentMeIfYouCan/road-anomaly-"benchmark"/blob/master/doc/RoadAnomaly/credits.txt" for detail',
  ...
  },
  {
    ...
    sensors: "camera, lidar, radar, gps/imu",
    sensorDetail:
      "2x stereo cameras a front-facing Bumblebee XB3 and a back-facing Bumblebee2, 2x Velodyne HDL-32E lidars 360° 10Hz, 2x Pixelink PL-B742F industrial cameras 185°, 1x ibeo LUX 4L lidar 85°, 1x Continental ARS 308 radar, 1x SICK LMS100-10000 laser rangefinder 270° 12.5Hz, 1x Magellan ProFlex 500 GNSS, 1x Xsens MTi-28A53G25 IMU 100Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "8x cameras 2000x1200 10Hz, 5x lidar 20Hz, 1x imu 100Hz, 1x gnss 20Hz",
    recordingPerspective: "-",
    dataType: "Real",
    mapData: "No",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "Video sequences taken from BelgiumTS and different weather conditions and video quality simulated",
    recordingPerspective: "ego-perspective",
    dataType: "Real and Synthetic",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "4x 77 GHz series production automotive 60° radar sensor, 1x documentary camera",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "two different car types, 1x road-facing camera Sony IMX2984 20Hz, 1x gnss u-blox M8 chip5 10Hz, gyro and accelerometer data LSM6DS3 100Hz, magnetometer data AK09911 10Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "2x FLIR Blackfly 23S3C RGB camera 1920x650, 2x FLIR ADK cameras for thermal images 1920x650, 8x monophonic microphones",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, radar, gps/imu",
    sensorDetail:
      "1x ZED stereo camera 672x376 15Hz, 1x Velodyne HDL-32e LiDAR 32 channel 360° 10Hz, 1x Navtech CTS350-X radar 360°, 1x Advanced Navigation Spatial Dual GPS/IMU",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "",
    benchmark: "-",
  ...
  },
  {
    ...
    mapData: "No",
    benchmark:
      "find bounding box for objects based on user commands in natural language",
    annotations:
      "bounding box and command in natural language related to the bounding box",
    licensing: "MIT license",
    relatedDatasets: "-",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "The StreetLearn dataset is a limited set of Google Street View images",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
    annotations: "-",
    licensing:
      "The dataset is freely available upon request with a license agreement",
    relatedDatasets: "-",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "Videos obtained from the larger HDD dataset from the same research group",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    annotations:
      "Human voice describing action and attention of the driver seperately",
    licensing:
      "Available for research for people affiliated with a university upon registration",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "2x multi-view color cameras 1920x500 30Hz, 1x Velodyne HDL-64E lidar 10Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark:
      "dynamic 4D (3D+temporal) tracking, 5D (4D+interactive) interactive event recognition and intention prediction",
    annotations:
      "5D semantics, 3D bounding boxes, 4D object IDs, 5D interactive event and 5D intention",
    licensing: "-",
    relatedDatasets: "-",
    publishDate: "2019-05-20",
    lastUpdate: "-",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "Semantic and BEV annotations added to images taken from KITTI and NuScenes",
    recordingPerspective: "ego-perspective",
    dataType: "Real and Synthetic",
    mapData: "-",
    benchmark: "-",
    ...
    location:
      "Karlsruhe, Germany (KITTI); Boston, USA and Singapore (nuScenes)",
    rawData: "-",
  ...
  },
  {
    ...
    mapData: "No",
    benchmark:
      "binary lane marker segmentation, lane-dependent pixel-level segmentation and lane border regression",
    ...
    relatedPaper:
      "https://unsupervised-llamas.com/static/llamas/llamas_preview.pdf",
    location: "-",
    rawData: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar",
    sensorDetail:
      "1x Aptina AR0230 stereo camera 1920x1080 30Hz, 1x Velodyne HDL64-S3 lidar, 1x gated camera 10bit images 1280x720 120Hz",
    recordingPerspective: "Ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar",
    sensorDetail:
      "Monocular images and lidar pointclouds taken from KITTI dataset",
    recordingPerspective: "ego-perspective and bird's eye",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar",
    sensorDetail:
      "Monocular images and lidar pointclouds taken from nuScenes dataset",
    recordingPerspective: "ego-perspective and bird's eye",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    licensing:
      "Freely available to academic and non-academic entities for non-commercial purposes",
    relatedDatasets:
      "Daimler Pedestrian Path Prediction Benchmark Dataset, Daimler Stereo Pedestrian Detection Benchmark Dataset, Tsinghua-Daimler Cyclist Detection Benchmark Dataset",
  ...
  },
  {
    ...
    sensorDetail:
      'stereo cameras 22 cm baseline 17Hz, odometry from in-vehicle "sensors" & outs"id"e temperature & GPS tracks',
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark:
      "pixel-level semantic labeling, instance-level semantic labeling, panoptic semantic sabeling 3d vehicle detection",
    annotations:
      "dense semantic segmentation, instance segmentation for vehicles & people, 3d bounding boxes",
    licensing: "freely available for non-commercial purposes",
    relatedDatasets: "-",
  ...
  },
  {
    ...
    relatedPaper:
      "https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7293673",
  ...
  },
  {
    ...
    sensorDetail:
      "2x stereo cameras 1920x1024 30Hz, 1 gated camera 1280x720 120Hz, 1 FMCW radar 15Hz, 2x Velodyne lidars 10Hz, 1 FIR camera 640x480 30Hz, 1 Airmar WX150 weather sensor (temperature, wind speed and humidity)",
    recordingPerspective: "Ego-perspective",
    dataType: "real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    annotations: "2d bounding boxes",
    licensing:
      "freely available for non-commercial research and teaching activities",
    relatedDatasets: "-",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "2x Point-grey grasshopper cameras (NIR: GS3-U3-41C6NIR-C, RGB: GS3-U3-41C6C-C) 10Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    ...
    relatedPaper:
      "https://joonyoung-cv.github.io/assets/paper/18_ral_ranus.pdf",
    location: "-",
    rawData: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "1x Multi-View RGB 5 cameras set: 1280x800 90° 10Hz, 1x stereo RGB camera set 1280x800 90° 10Hz, 1x optical flow sensor, 1x depth camera 1280x800 90° 10Hz, 1x 128-channel LiDAR 36° 10Hz, 1x gnss sensor, 1x imu sensor",
    recordingPerspective: "ego-perspective",
    dataType: "Synthetic",
    mapData: "No",
    benchmark: "-",
    annotations:
      "2d/3d bounding boxes, optical flow, depth maps, instance segmentation and semantic segmentation",
    licensing:
      "Creative Commons Attribution-ShareAlike 4.0 International License",
    relatedDatasets: "",
  ...
  },
  {
    ...
    sensors: "camera, lidar, radar, gps/imu",
    sensorDetail:
      "2x Grasshopper3 cameras 1920x1200 163Hz, 1x Velodyne HDL-32E 10Hz, 1x Continental ARS308 long-range radar 56° 15Hz, 2x  Continental SRR208 blind-corner radars 150° 33Hz, 1x Trimble Net R9 Geospatial gnss 20Hz, 1x MPU6050 imu",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    annotations:
      "bounding box, trajectory information, lane markings, object classification",
    licensing:
      "Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)",
    relatedDatasets: "-",
    publishDate: "2019-10-27",
  ...
  },
  {
    ...
    relatedDatasets:
      "Seasonal Variation Dataset, Illumination Changes in a day",
    publishDate: "2014-06-11",
    lastUpdate: "-",
    paperTitle:
      "Understanding How Camera Configuration and Environmental Conditions Affect Appearance-based Localization",
  ...
  },
  {
    ...
    sensors: "camera, imu/gps",
    sensorDetail:
      "2x Basler Scout scA1300-32fm Firewire greyscale cameras 1.2MP 33Hz, 1x XSens MTi miniature MEMS-based Attitude and Heading Reference System, 1x Android GPS",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    ...
    relatedPaper:
      "https://link.springer.com/content/pdf/10.1007/978-3-319-23192-1_49.pdf",
    location: "Mexico",
    rawData: "Yes",
  ...
  },
  {
    ...
    sensors: "lidar",
    sensorDetail:
      "Dataset taken from SemanticKITTI which is based on KITTI and then lidar data is annotated",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "1x Point Grey Ladybug 3^2 camera, 6x synchronized global shutter color cameras 616x1616 360° 30Hz, 1x XSens MTi AHRS3 imu sensor, 1x uBlox AEK-4P GPS sensor, 1x Kistler Correvit S-350 Aqua velocity sensor, 1x Kistler HF-500C Height sensor",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    ...
    relatedPaper:
      "http://liu.diva-portal.org/smash/get/diva2:623885/FULLTEXT01.pdf",
    location: "Sweden",
    rawData: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps",
    sensorDetail:
      "1x color SEKONIX SF332X-10X video camera 1928x1280 30Hz, 4x Velodyne VLP-32C 3D LiDARs 10Hz, 1x MTi-G-710-GNSS/INS-2A8G4 gyroscope/gps",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "driver intention and vehicle trajectory prediction",
    annotations:
      "2d/3d bounding boxes, driver intention labels, environmental labels, contextual labels",
    licensing:
      "Available for research for people affiliated with a university upon registration",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "The dataset has been constructed from KITTI, nuScenes, SODA10M and ONCE datasets",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "anomaly detection, object detection",
    annotations:
      "Image domain tags (i.e., periods and weather conditions) and 2D bounding boxes",
    licensing:
      "Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International Public License (“CC BY-NC-SA 4.0”)",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "Mobile cameras with recording applications 1920x1080 resolution",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "self-supervised learning for dataset labelling",
    annotations:
      "Image tags (i.e., weather conditions, location scenes, periods) for all images and 2D bounding boxes",
    licensing:
      "Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International Public License (“CC BY-NC-SA 4.0”)",
    relatedDatasets: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar",
    sensorDetail:
      "1x HESAI Pandar 40P 40 laser beams lidar 360° 10/20Hz, 1x Jaguar Prime from Innovusion 300 beams lidar 6-20Hz, RGB cameras 1920x1080 30-60Hz",
    recordingPerspective: "ego-perspective, bird's eye",
    dataType: "Real",
    mapData: "-",
    benchmark: "-",
    annotations:
      "2D and 3D bounding boxes of the obstacle objects as well as their category attributes, occlusions, and truncated states",
    licensing: "Available upon registration",
  ...
  },
  {
    ...
    sensors: "camera, lidar",
    sensorDetail:
      "4x Basler ace acA1920-50gc traffic camera 1920x1200, 1x  Ouster OS1-64 360°",
    recordingPerspective: "Bird's Eye",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "Images taken from KITTI dataset and introduce amodal segmentation, image resolution of 1408x376",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "Images taken from BDD100K dataset and introduce amodal segmentation, image resolution of 1408x376",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "Amodal panoptic segmentation",
  ...
  },
  {
    ...
    benchmark: "-",
    annotations:
      "road places, road types, weather, and road surface conditions",
    licensing:
      "Available for research for people affiliated with a university upon registration",
  ...
  },
  {
    ...
    relatedPaper:
      "https://openaccess.thecvf.com/content/CVPR2022/papers/Zendel_Unifying_Panoptic_Segmentation_for_Autonomous_Driving_CVPR_2022_paper.pdf",
    location: "All over the world",
    rawData: "Yes",
  ...
  },
  {
    ...
    sensors: "lidar",
    sensorDetail:
      "Velodyne HDL-64E from sequences of the odometry 'benchmark' of the KITTI Vision Benchmark with 360° view",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark:
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "1x DJI Matrice 200 Serie V2 equipped with a DJI Zenmuse gimbal camera 4096x2160 25Hz",
    recordingPerspective: "top-view",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, radar, gps/imu",
    sensorDetail:
      "4x ZED2i stereo cameras 1280x720 110° 30Hz, 1x os2-64 long range Lidar 360° 10Hz, 1x os1-128 high res. Lidar 360° 10Hz, 1x RETINA-4ST 4D Radar 107° 10Hz, 1x GPS500 C94-M8P3 RTK-GPS 1Hz, 2x IMUs (built in LiDaR) 100Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    annotations:
      "Annotated 3d bounding boxes with doppler, range, azimuth, and elevation dimensions",
  ...
  },
  {
    ...
    annotations: "semantic segmentation",
    licensing:
      "freely available to academic and nonacademic entities for non-commercial purposes",
  ...
  },
  {
    ...
    licensing: "-",
    relatedDatasets:
      "DriveSeg (MANUAL), MIT-AVT Clustered Driving Scene Dataset",
    publishDate: "2020-04-06",
    lastUpdate: "-",
    paperTitle:
      "Value of Temporal Dynamics Information in Driving Scene Segmentation",
  ...
  },
  {
    ...
    benchmark: "-",
    annotations:
      "pixel-level mask and temporal tracking label across frames for objects ",
    licensing: "-",
    relatedDatasets: "-",
    publishDate: "2019-06-15",
    lastUpdate: "-",
  ...
  },
  {
    ...
    relatedPaper:
      "https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9684368",
  ...
  },
  {
    ...
    sensors: "camera, lidar",
    sensorDetail:
      "4x Sekonix SF3325-100 cameras 1928x1208 30Hz, 2x Velodyne Puck (VLP-16) LiDAR 10Hz, 1x Ouster OS2-128 long range LiDAR 10Hz, 1x Novatel PwrPak7D dual GNSS-502 antenna, 1x Epson G320N IMU",
    recordingPerspective: "ego-perspetive",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "6x NVIDIA 2Mega SF3322 automotive GMSL cameras 1928x1208 30Hz , 1x 3D Velodyne Puck VLP-16 10 Hz 360°, 1x VN-100 IMU, 1x U-Blox NEO-M8P real-time kinematics GNSS",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
    ...
    licensing: "Freely available for non-commercial purposes",
    relatedDatasets:
      "Five Roundabouts Dataset,  Naturalistic Intersection Driving Dataset, High Resolution Fused GPS and Dead Reckoning",
  ...
  },
  {
    ...
    lengthOfScenes: "20",
    sensors: "camera, lidar",
    sensorDetail: "6x cameras 1024x968 20Hz, 4x lidars combined 360° 10Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps",
    sensorDetail:
      "2x Sensing-SG5 color cameras Sony IMX490RGGB 1920x1080 30Hz, 1x Robosense Ruby-Lite Lidar 360° 10Hz, 1x BS-280 GPS",
    recordingPerspective: "Bird's Eye",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar",
    sensorDetail:
      "1x Raspberry Pi Camera Module v2 1640x1232 62.2° 30Hz, 1x Dream Chip Technologies ATOM One 1920x1080 89° 50Hz, 1x Xiaomi Yi Action Camera 1920x1080 155° 30Hz, 1x Velodyne VLP-16 360° 10Hz, 1x Velodyne HDL64-S3 360° 10Hz, 1x Hesai Pandar64 360° 10Hz, 1x Hesai PandarQT 360° 10Hz",
    recordingPerspective: "bird's eye view",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
    ...
    relatedPaper:
      "https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9827157",
  ...
  },
  {
    ...
    relatedPaper:
      "https://automatumdata.blob.core.windows.net/opendataset/IV21_Automatum.Data.eng.pdf",
    location: "Germany",
    rawData: "-",
  ...
  },
  {
    ...
    relatedDatasets:
      "CARLA-WildLife (CWL) and Wuppertal Obstacle Sequences (WOS)",
  ...
  },
  {
    ...
    licensing: "Creative Commons Attribution 4.0 International",
    relatedDatasets:
      "Street Obstacle Sequences (SOS) and Wuppertal Obstacle Sequences (WOS)",
    publishDate: "2022-10-05",
    lastUpdate: "-",
    paperTitle:
      "Two Video Data Sets for Tracking and Retrieval of Out of Distribution Objects",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "1x RGB camera 1280x960 30Hz, 1x Semantic Segmentation camera 1280x960 30Hz, 1x Depth camera 1280x960 30Hz, 1x Velodyne 16/64 lidar 30Hz, 1x Velodyne 16/64 Semantic lidar 30Hz, 1x IMU, 1x GNSS",
    recordingPerspective: "ego-perspective",
    dataType: "Synthetic",
    mapData: "Yes",
    benchmark: "odometry methods in autonomous driving",
    annotations:
      "semantic annotation at the instance level for both image and lidar data",
    licensing: "-",
    relatedDatasets: "-",
    ...
    relatedPaper:
      "https://openaccess.thecvf.com/content/CVPR2022W/WAD/papers/Kloukiniotis_CarlaScenes_A_Synthetic_Dataset_for_Odometry_in_Autonomous_Driving_CVPRW_2022_paper.pdf",
    location: "CARLA",
    rawData: "-",
  ...
  },
  {
    ...
    sensorDetail:
      "1x Point Grey Grasshopper camera 1928x1448 6Hz, 1x Velodyne HDL-64 lidar 360° 10Hz, 1x OXTS RT3003 INS gps, 1x Localizing Ground Penetrating Radar (LGPR) Sensor components include a 12 element radar array, a switch matrix, an OXTS RTK-GPS unit 126Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
  ...
  },
  {
    ...
    sensorDetail:
      "2x fisheye cameras 1920x1080 30-60Hz, 2x pinhole cameras 2896x1876 30-40Hz, 1x LiDAR 360° 10Hz, 2x Radar 18Hz, 1x GNSS+INS 100Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    benchmark: "-",
    annotations:
      "Seasons, Weather, Lanes, Illuminnation, Simplified Road Type, Others",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "Dataset taken from Cityscapes and occlusions pasted artficially for amodal segmentation tasks",
    recordingPerspective: "ego-perspective",
    dataType: "-",
    mapData: "No",
  ...
  },
  {
    ...
    benchmark: "object detection",
    annotations:
      "bounding boxes for oncoming vehicles and their light projections/reflections",
    licensing:
  ...
  },
  {
    ...
    sensorDetail:
      "1x FLIR Blackfly 3.2MP, MARWIS: Mobile Advanced Road Weather Information Sensor",
    recordingPerspective: "Bird's Eye View",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    ...
    relatedPaper:
      "https://openaccess.thecvf.com/content/CVPR2022W/WAD/papers/Cordes_RoadSaW_A_Large-Scale_Dataset_for_Camera-Based_Road_Surface_and_Wetness_CVPRW_2022_paper.pdf",
  ...
  },
  {
    ...
    benchmark: "-",
    annotations:
      "semantic segmentation of images, driver gaze map, vehice speed, throtle and steering data",
    licensing:
      "Available for research for people affiliated with a university upon registration",
  ...
  },
  {
    ...
    mapData: "No",
    benchmark:
      "Domain adaptation techniques on in-the-wild road-scene videos collected from the Internet",
  ...
  },
  {
    ...
    mapData: "No",
    benchmark:
      "Lane merging visual and Trajectory Planning, 3d object detection, 3d object tracking",
    annotations:
      "ground truth 3D reference positions from GNSS modules, speed, acceleration, heading",
    licensing:
      "Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)",
  ...
  },
  {
    ...
    paperTitle:
      "V2I-CARLA: A Novel Dataset and a Method for Vehicle Reidentification-Based V2I Environment",
    citationCount: 0,
    completionStatus: "incomplete",
  },
  {
  ...
  },
  {
    ...
    relatedPaper:
      "https://www.ri.cmu.edu/publications/towards-hd-map-updates-with-crosswalk-change-detection-from-vehicle-mounted-cameras/",
    paperTitle:
  ...
  },
  {
    ...
    paperTitle:
      "Extended trajectory data from Indian Traffic at three flow conditions",
    citationCount: 0,
    completionStatus: "partially Complete",
  },
  {
  ...
  },
  {
    ...
    relatedPaper:
      "https://www.sciencedirect.com/science/article/abs/pii/S0957417422022606",
  ...
  },
  {
    ...
    relatedPaper:
      "https://openaccess.thecvf.com/content/WACV2023/papers/Trinh_PP4AV_A_Benchmarking_Dataset_for_Privacy-Preserving_Autonomous_Driving_WACV_2023_paper.pdf",
    paperTitle:
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "monocular color camera 1920x1200, velodyne 32 lidar, gps/imu",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "Photos privately captured and part of it sourced online and labelled",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
    ...
    relatedPaper:
      "https://link.springer.com/article/10.1007/s41066-019-00182-6",
    location: "-",
    rawData: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, radar, gps/imu",
    sensorDetail:
      "5x color cameras 1920x720 10Hz, 5x depth cameras 1920x720 10Hz, 3x lidar 64/800/1200 channels 360° 10Hz, 1x SPAD-LiDAR, 4x radar 360° 10Hz, 1x gps/imu 10Hz",
    recordingPerspective: "Bird’s Eye",
    dataType: "Real",
    benchmark: "3d object detection, trajectory forecasting",
    annotations:
      "2d/3d bounding boxes, object category and attributes, 2d-3d semantic, instance and panoptic segmentation",
    licensing:
      "freely available for both commercial and non-commercial purposes",
    relatedDatasets: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, radar",
    sensorDetail:
      "1x Point Grey Blackfly camera 2048x618 30Hz, 1x Velodyne VLP-16 10Hz, 1x Astyx 6455 HiRes 110° 13Hz",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    relatedPaper:
      "https://blog.getnexar.com/https-medium-com-itayklein-intro-nexet-50e9b596d0e5",
  ...
  },
  {
    ...
    relatedPaper:
      "https://www.sciencedirect.com/science/article/pii/S2352340921004170#bib0001",
  ...
  },
  {
    ...
    sensors: "camera",
    sensorDetail:
      "1x Teledyne FLIR Tau 2 640x512 45°, 1x Teledyne FLIR Blackfly S BFS-U3-51S5C (IMX250) camera 52.8°",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "No",
    benchmark: "-",
  ...
  },
  {
    ...
    sensors: "camera, lidar, gps/imu",
    sensorDetail:
      "1x Mobileye ELD camera, 3x Velodyne VLP-16 Hi-Res lidar, 1x Inertial Lab INS D gnss/imu sensor",
    recordingPerspective: "ego-perspective",
    dataType: "Real",
    mapData: "Yes",
    benchmark: "-",
